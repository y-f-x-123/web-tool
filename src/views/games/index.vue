<template>
  <div class="box">
    <a class="game-item" target="_blank" href="/games/snake.html">
    ...
    <a class="game-item" target="_blank" href="/games/five-chess.html">
    ...
    <a class="game-item" target="_blank" href="/games/fly-bird/index.html">
    ...
    <a
      class="game-item"
      target="_blank"
      href="https://edition.cnn.com/interactive/2021/03/cnnix-steership/"
    >
    ...
    <a class="game-item" target="_blank" href="https://www.yikm.net/">
      <img
        src="https://img1.baidu.com/it/u=2482939586,277649298&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
        alt=""
        class="game-logo"
      />
      <div class="game-info">
        ...
        <div class="game-desc">
          ...
          games，NES games online，Super Mario
        </div>
      </div>
    </a>
    ...
    <a class="game-item" target="_blank" href="https://yzyx.info/">
      <img
        src="https://yzyx.info/images/favicon.png"
        alt=""
        class="game-logo"
      />
      <div class="game-info">
    ...
    <a
      class="game-item"
      target="_blank"
      href="https://beta.deeeep.io/?host=BPIx93"
    >
      <img
        src="https://beta.deeeep.io/favicon-32x32.png"
        alt=""
        class="game-logo"
      />
      <div class="game-info">
